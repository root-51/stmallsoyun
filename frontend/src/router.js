...
import StockIventoryManager from "./components/listers/StockIventoryCards"
import StockIventoryDetail from "./components/listers/StockIventoryDetail"
...
export default new Router({
    ...
    routes: [
            ...
            {
                path: '/stocks/iventories',
                name: 'StockIventoryManager',
                component: StockIventoryManager
            },
            {
                path: '/stocks/iventories/:id',
                name: 'StockIventoryDetail',
                component: StockIventoryDetail
            },
